...
var app = (function () {
    ...
    /* src\Note.svelte generated by Svelte v3.45.0 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*pageData*/ 1 && iframe_srcdoc_value !== (iframe_srcdoc_value = "<html>" + /*pageData*/ ctx[0] + "</html>")) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function fetchData() {
    		fetch($page).then(response => response.text()).then(data => $$invalidate(0, pageData = data));
    	}
