...
var app = (function () {
    ...
    // (43:4) {#each notes as note}
    function create_each_block(ctx) {
    	let div;
    	let p0;
    	let t0_value = /*note*/ ctx[4].name + "";
    	let t0;
    	let t1;
    	let p1;
    	let t2_value = /*note*/ ctx[4].subject + "";
    	let t2;
    	let t3;
    	let p2;
    	let t4_value = /*note*/ ctx[4].link + "";
    	let t4;
    	let t5;
    	let br;
    	let t6;
    	...
    	const block = {
    		c: function create() {
    			...
    			br = element("br");
    			t6 = space();
    			add_location(p0, file, 44, 12, 1306);
    			add_location(p1, file, 45, 12, 1338);
    			add_location(p2, file, 46, 12, 1373);
    			add_location(br, file, 47, 12, 1405);
    			attr_dev(div, "class", "card");
    			add_location(div, file, 43, 8, 1274);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*notes*/ 1 && t0_value !== (t0_value = /*note*/ ctx[4].name + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*notes*/ 1 && t2_value !== (t2_value = /*note*/ ctx[4].subject + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*notes*/ 1 && t4_value !== (t4_value = /*note*/ ctx[4].link + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(43:4) {#each notes as note}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 41, 0, 1211);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
