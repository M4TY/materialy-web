...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			nav = element("nav");
    			a0 = element("a");
    			a0.textContent = "Čeština";
    			t1 = space();
    			a1 = element("a");
    			a1.textContent = "Matematika";
    			attr_dev(a0, "class", "svelte-17h1477");
    			add_location(a0, file$1, 1, 2, 8);
    			attr_dev(a1, "class", "svelte-17h1477");
    			add_location(a1, file$1, 2, 2, 25);
    			attr_dev(nav, "class", "svelte-17h1477");
    ...
    /* src/components/Content.svelte generated by Svelte v3.45.0 */
    ...
    // (42:2) {#each notes as note}
    function create_each_block(ctx) {
    	let p;
    	let t_value = /*note*/ ctx[4].link + "";
    	let t;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*notes*/ 1 && t_value !== (t_value = /*note*/ ctx[4].link + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(42:2) {#each notes as note}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "grid-wrapper svelte-1whakc5");
    			add_location(div, file, 40, 0, 960);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function fetchData() {
    		fetch("https://api.github.com/repos/M4TY/zapisky/git/trees/main?recursive=1").then(response => response.json()).then(data => {
    			temp = data.tree;
    			filterData(temp);
    		});
    	}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Navbar, Content });
    	return [];
    }
